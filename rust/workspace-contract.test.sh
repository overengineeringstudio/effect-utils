...
expected_packages='["buck2-archive-tool","buck2-closure-tool","buck2-package-evidence","buck2-product","buck2-tool-core","buck2-typescript-product","otel-scrape","otelite"]'
