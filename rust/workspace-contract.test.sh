...
expected_packages='["buck2-closure-tool","buck2-package-evidence","buck2-portable-toolchain","buck2-portable-toolchain-fixture","buck2-tool-core","buck2-typescript-product","otel-scrape","otelite"]'
