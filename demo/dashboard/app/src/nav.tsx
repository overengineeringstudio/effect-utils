...
type NavItem =
  | { kind: 'solo'; demo: DemoModel }
  | { kind: 'group'; groupId: string; label: string; members: DemoModel[] }
...
export const TabButton = ({
  ...
  >
    <kbd
      className={`border-0 bg-transparent p-0 font-mono text-[11px] ${on ? 'text-accent' : 'text-fg-faint'}`}
    >
      {d.displayNum}
    </kbd>
    {d.tab}
