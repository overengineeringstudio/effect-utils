...
steelman explored the *strong* form — core distro + minimal OCB build + the
...
- **`fileexporter` is a *contrib* component**, not core, so even a minimal OCB
...
is an *explicit non-goal* of the issue. Tail-sampling / filter / fan-out / batch
