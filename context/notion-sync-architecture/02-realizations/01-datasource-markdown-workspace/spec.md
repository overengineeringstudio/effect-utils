# Datasource Markdown Workspace Spec
...
datasource Markdown workspace realization contract that composes and constrains
the package-scoped contracts in
...
The stack-wide Notion sync source of truth is
[`context/notion-sync-architecture`](../../requirements.md).

This realization intentionally has no separate `vision.md`; it refines the
stack vision through its requirements, spec, glossary, intuition, and decision
records.
