...
| ------------------------------------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Hard clean break: remove `rows`/`_nds_*`/unversioned layouts; unknown namespace fails closed with tracking guidance | Selected | One product contract; no dual-surface ambiguity (vision "What This Is Not"); pre-release so no external users to migrate; VRS explicitly requires this (T03, R05, Decision 0013). |
