...
PR #775 implements one coherent system across packages, so the integrated contract
must have a single home. Phase 0 reconciles all per-package VRS to the
...
| ------------------------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------- |
| Cross-cutting `context/` VRS is canonical; per-package VRS scopes down and must not contradict it | Selected | The whole point of #775 is one coherent system across packages; the integrated contract must have a single home.          |
...
Per-package specs that previously diverged must be reconciled in Phase 0 before
