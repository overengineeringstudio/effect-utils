...
exposes platform and selected-tool facts to that contract. The current Python
replacement delta is retained as an experiment, not a timeless platform rule.
