...
- **BUCK.EXEC.RUST-R03 Single request authority:** One first-party Rust intent
  must determine canonical Cargo dependency requests and any resolver-root
  projection. Parallel handwritten dependency request surfaces are forbidden.
  Refines: BUCK.EXEC-R01, BUCK.EXEC-R03.
