...
| Telemetry constants        | `context/otel-utils/otel-scrape/telemetry-registry.json` (`profileFields`, `profile_type`/`profile_digest` attrs) → generated `src/telemetry_registry.gen.rs` (genie)                                                                                             |
