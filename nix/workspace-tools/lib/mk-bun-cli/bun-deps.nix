...
let
  ...
  depsFingerprintDrv = pkgs.stdenvNoCC.mkDerivation depsDrvCommon;
  depsBuildFingerprint = baseNameOf (builtins.unsafeDiscardStringContext depsFingerprintDrv.drvPath);
in
