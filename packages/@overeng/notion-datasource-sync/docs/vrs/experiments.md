...
| E12           | Current Notion API proof risks for `2026-03-11`, query completeness, markdown guards, webhooks, and Workers | Automated fake-service coverage plus live smoke re-verification under the pinned API version                                      |
...
**Hypothesis:** The datasource-sync verification contract must track the current public Notion API, not only earlier live observations.
...
- The current API version to prove is `2026-03-11`; API-contract tests must catch `archived`/`in_trash`, `transcription`/`meeting_notes`, and block append `position` drift.
...
| Gap                                            | Why it matters                                                                                                              | Current blocked behavior                                                                          |
| ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
...
| SQLite migration corpus                        | Versioned stores need upgrade proof once schemas ship                                                                       | Start the corpus with the first implemented store version and require upgrade fixtures thereafter |
...
| API `2026-03-11` live re-verification          | Earlier live observations remain useful but need pinned-version regression proof                                            | Keep the API proof manifest blocked until fake-service coverage and live smoke pass               |
