...
| ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| View create/update/delete                         | Official docs expose create, update, and delete endpoints.                                                                              | Keep separate from read-only `notion_views` inventory and row membership; require explicit view commands, stale-base checks, and live cleanup because view deletion cannot be undone through the API. |
