...
- **GW-R01 Client boundary:** Raw Notion HTTP access must remain in the API-client layer; datasource-sync consumes typed gateway services.
- **GW-R02 Gateway ports:** Datasource sync must depend on typed ports for Notion data sources, pages, page bodies, files, and local storage.
