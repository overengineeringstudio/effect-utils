...
settlement as normal sync (see [../09-sync-orchestration/spec.md](../09-sync-orchestration/spec.md)).
...
`track`; see [../11-cli/spec.md](../11-cli/spec.md) CLI-R07) decides WHAT the loop
...
[sync-orchestration sub-system](../09-sync-orchestration/spec.md).
