 ...
 * repository. The JSON is consumed by the `devenv tasks run gh:check-labels` /
 * `devenv tasks run gh:apply-labels` devenv tasks, which diff it against live GitHub state
