...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-lrwLhjrwhbtvO0CmciQy1UyTmPmT9uzC1KK7uQpZ99w=";
        aarch64-linux = "sha256-lrwLhjrwhbtvO0CmciQy1UyTmPmT9uzC1KK7uQpZ99w=";
        x86_64-linux = "sha256-lrwLhjrwhbtvO0CmciQy1UyTmPmT9uzC1KK7uQpZ99w=";
      };
    };
