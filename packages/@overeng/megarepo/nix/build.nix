...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-Tbh1Wia3OOvARVmRuTBvABH/roDQzufSMy2GXDEMSNY=";
        aarch64-linux = "sha256-Tbh1Wia3OOvARVmRuTBvABH/roDQzufSMy2GXDEMSNY=";
        x86_64-linux = "sha256-Tbh1Wia3OOvARVmRuTBvABH/roDQzufSMy2GXDEMSNY=";
      };
    };
