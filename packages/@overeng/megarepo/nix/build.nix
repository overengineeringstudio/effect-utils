...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-cSwuX/JiPFZQ01z+/I5FEkakDKqMKKq5dLmQKxtKUpw=";
        aarch64-linux = "sha256-cSwuX/JiPFZQ01z+/I5FEkakDKqMKKq5dLmQKxtKUpw=";
        x86_64-linux = "sha256-cSwuX/JiPFZQ01z+/I5FEkakDKqMKKq5dLmQKxtKUpw=";
      };
    };
