...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-ZJXbSvsTYROG/Y1zo+6VQm4zub3HMITqHVB74guWAvw=";
        aarch64-linux = "sha256-ZJXbSvsTYROG/Y1zo+6VQm4zub3HMITqHVB74guWAvw=";
        x86_64-linux = "sha256-ZJXbSvsTYROG/Y1zo+6VQm4zub3HMITqHVB74guWAvw=";
      };
    };
