...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-CzytDzDBhMWFvj7AnhORRrDri1oju2eynXkorJoJAcY=";
        aarch64-linux = "sha256-CzytDzDBhMWFvj7AnhORRrDri1oju2eynXkorJoJAcY=";
        x86_64-linux = "sha256-CzytDzDBhMWFvj7AnhORRrDri1oju2eynXkorJoJAcY=";
      };
    };
