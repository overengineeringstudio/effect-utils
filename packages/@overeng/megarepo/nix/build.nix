...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-teszhVDp92eW/hpYy3DNpxiXq4OZvSztHqqF7Kr4O9E=";
        aarch64-linux = "sha256-teszhVDp92eW/hpYy3DNpxiXq4OZvSztHqqF7Kr4O9E=";
        x86_64-linux = "sha256-teszhVDp92eW/hpYy3DNpxiXq4OZvSztHqqF7Kr4O9E=";
      };
    };
