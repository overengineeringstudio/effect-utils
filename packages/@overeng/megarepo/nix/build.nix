...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-n6wCMwKufCbnIvesC0zzhcs5Pr9GTkpJoDHqROKQIUo=";
        aarch64-linux = "sha256-n6wCMwKufCbnIvesC0zzhcs5Pr9GTkpJoDHqROKQIUo=";
        x86_64-linux = "sha256-n6wCMwKufCbnIvesC0zzhcs5Pr9GTkpJoDHqROKQIUo=";
      };
    };
