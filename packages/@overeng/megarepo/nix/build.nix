...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-aYpSkAJu4CE47RSCCElsA07tNmZR1w9cmXun1s4XPhg=";
        aarch64-linux = "sha256-aYpSkAJu4CE47RSCCElsA07tNmZR1w9cmXun1s4XPhg=";
        x86_64-linux = "sha256-aYpSkAJu4CE47RSCCElsA07tNmZR1w9cmXun1s4XPhg=";
      };
    };
