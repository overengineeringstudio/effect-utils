...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-UqHcI7pB4+osGvljBcsC1zaXTvuyFn3jGu3UK00y0Q4=";
        aarch64-linux = "sha256-UqHcI7pB4+osGvljBcsC1zaXTvuyFn3jGu3UK00y0Q4=";
        x86_64-linux = "sha256-UqHcI7pB4+osGvljBcsC1zaXTvuyFn3jGu3UK00y0Q4=";
      };
    };
