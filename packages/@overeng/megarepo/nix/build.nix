...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-8Ts92xYnTtXkiyb9uhJc/XsCgIFc/+mFUEv+zb5C1Fg=";
        aarch64-linux = "sha256-8Ts92xYnTtXkiyb9uhJc/XsCgIFc/+mFUEv+zb5C1Fg=";
        x86_64-linux = "sha256-8Ts92xYnTtXkiyb9uhJc/XsCgIFc/+mFUEv+zb5C1Fg=";
      };
    };
