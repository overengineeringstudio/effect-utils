...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-XUbqD44snvD831SFQZqByEhvoygqDr2cs2wOFc+11BA=";
        aarch64-linux = "sha256-XUbqD44snvD831SFQZqByEhvoygqDr2cs2wOFc+11BA=";
        x86_64-linux = "sha256-XUbqD44snvD831SFQZqByEhvoygqDr2cs2wOFc+11BA=";
      };
    };
