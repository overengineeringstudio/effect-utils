...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-WF+XOhTjqS/jjSkqPkT4VffQ0rq2tCEu7pQtozQzRpU=";
        aarch64-linux = "sha256-WF+XOhTjqS/jjSkqPkT4VffQ0rq2tCEu7pQtozQzRpU=";
        x86_64-linux = "sha256-WF+XOhTjqS/jjSkqPkT4VffQ0rq2tCEu7pQtozQzRpU=";
      };
    };
