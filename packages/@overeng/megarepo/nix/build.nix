...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-fgPtIgjLARo/TdL0uLO3uXNvbDi8A946VYiO8FU070I=";
        aarch64-linux = "sha256-fgPtIgjLARo/TdL0uLO3uXNvbDi8A946VYiO8FU070I=";
        x86_64-linux = "sha256-fgPtIgjLARo/TdL0uLO3uXNvbDi8A946VYiO8FU070I=";
      };
    };
