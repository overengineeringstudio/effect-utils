...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-jP00NcEosMZo9ZcKBdhD0OMv5l3Ew7qqOfRIlQOulDE=";
        aarch64-linux = "sha256-jP00NcEosMZo9ZcKBdhD0OMv5l3Ew7qqOfRIlQOulDE=";
        x86_64-linux = "sha256-jP00NcEosMZo9ZcKBdhD0OMv5l3Ew7qqOfRIlQOulDE=";
      };
    };
