...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-GS4weqZtPu0kkQxdhAcC/YV8K7E29ceHYy0s6v7P7RE=";
        aarch64-linux = "sha256-GS4weqZtPu0kkQxdhAcC/YV8K7E29ceHYy0s6v7P7RE=";
        x86_64-linux = "sha256-GS4weqZtPu0kkQxdhAcC/YV8K7E29ceHYy0s6v7P7RE=";
      };
    };
