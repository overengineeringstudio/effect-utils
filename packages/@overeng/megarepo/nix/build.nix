...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-hPr3ysrFxLkXLlA3ein4xAr3IG9RwceWJLTtX9/8iek=";
        aarch64-linux = "sha256-hPr3ysrFxLkXLlA3ein4xAr3IG9RwceWJLTtX9/8iek=";
        x86_64-linux = "sha256-hPr3ysrFxLkXLlA3ein4xAr3IG9RwceWJLTtX9/8iek=";
      };
    };
