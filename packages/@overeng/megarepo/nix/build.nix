...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-/0qeOKiciFMBDgIoNqpCROBgN4JZOybSihJr80B/MxE=";
        aarch64-linux = "sha256-/0qeOKiciFMBDgIoNqpCROBgN4JZOybSihJr80B/MxE=";
        x86_64-linux = "sha256-/0qeOKiciFMBDgIoNqpCROBgN4JZOybSihJr80B/MxE=";
      };
    };
