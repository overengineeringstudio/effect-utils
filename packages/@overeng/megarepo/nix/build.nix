...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-V2iHFVEQZ+15JD9ihAHBgxyI2J3DbCKNLF1D4cArm7I=";
        aarch64-linux = "sha256-V2iHFVEQZ+15JD9ihAHBgxyI2J3DbCKNLF1D4cArm7I=";
        x86_64-linux = "sha256-V2iHFVEQZ+15JD9ihAHBgxyI2J3DbCKNLF1D4cArm7I=";
      };
    };
