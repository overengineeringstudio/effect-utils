...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-azgYHeyIaoOcTAfyVMU6SVjOeCuRD7RLmWrNxUTQWw0=";
        aarch64-linux = "sha256-azgYHeyIaoOcTAfyVMU6SVjOeCuRD7RLmWrNxUTQWw0=";
        x86_64-linux = "sha256-azgYHeyIaoOcTAfyVMU6SVjOeCuRD7RLmWrNxUTQWw0=";
      };
    };
