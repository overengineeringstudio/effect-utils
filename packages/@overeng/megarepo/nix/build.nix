...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-4xB16nXkaDrbJPsjS6q5qlkj6TI7drP4zgbiuUjRIzA=";
        aarch64-linux = "sha256-4xB16nXkaDrbJPsjS6q5qlkj6TI7drP4zgbiuUjRIzA=";
        x86_64-linux = "sha256-4xB16nXkaDrbJPsjS6q5qlkj6TI7drP4zgbiuUjRIzA=";
      };
    };
