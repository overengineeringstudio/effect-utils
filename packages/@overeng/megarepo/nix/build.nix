...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-wEqNKFx8ArcOrdqfQE9sXrowXVwfvY0frMWPrp+8LkI=";
        aarch64-linux = "sha256-wEqNKFx8ArcOrdqfQE9sXrowXVwfvY0frMWPrp+8LkI=";
        x86_64-linux = "sha256-wEqNKFx8ArcOrdqfQE9sXrowXVwfvY0frMWPrp+8LkI=";
      };
    };
