...
let
  ...
  base = mkPnpmCli {
    ...
    depsBuilds = {
      "." = mkHash {
        aarch64-darwin = "sha256-hvOp/DWCyKDi08P0jdfd/BGCdU5C9ZPJ+0QmVwXs0l0=";
        aarch64-linux = "sha256-hvOp/DWCyKDi08P0jdfd/BGCdU5C9ZPJ+0QmVwXs0l0=";
        x86_64-linux = "sha256-hvOp/DWCyKDi08P0jdfd/BGCdU5C9ZPJ+0QmVwXs0l0=";
      };
    };
