/**
 * Storybook stories for StoreStatusOutput component.
 */
...
const meta: Meta<StoreStatusOutputProps> = {
  ...
  argTypes: {
    diskUsage: {
      description: 'Optional disk usage string',
      control: { type: 'text' },
      table: { category: 'Stats' },
    },
    repoCount: {
      description: 'Number of repositories in store',
      control: { type: 'number' },
      table: { category: 'Stats' },
    },
    worktreeCount: {
      description: 'Number of worktrees in store',
      control: { type: 'number' },
      table: { category: 'Stats' },
    },
  },
