/**
 * Vendored from aidenybai/tailwind-stylex@0.1.1 (tokens.stylex.js).
 * Copyright 2026-present Aiden Bai; MIT licensed. See ../THIRD_PARTY_NOTICES.
 */
/* eslint-disable overeng/jsdoc-require-exports -- Vendored upstream definitions; see THIRD_PARTY_NOTICES. */
