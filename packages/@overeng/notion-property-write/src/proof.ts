 ...
 */
export const decodePropertyWriteProof = Schema.decodeUnknownEffect(PropertyWriteProof, {
  onExcessProperty: 'error',
})

/** Decode an unknown value as a {@link DesiredPropertyWrite}, rejecting unknown fields. */
export const decodeDesiredPropertyWrite = Schema.decodeUnknownEffect(DesiredPropertyWrite, {
  onExcessProperty: 'error',
})
