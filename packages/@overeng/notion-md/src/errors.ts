...
export class NmdFrontmatterError extends Schema.TaggedErrorClass<NmdFrontmatterError>()(
  'NmdFrontmatterError',
  {
    path: Schema.String,
...
export class NmdObjectStoreError extends Schema.TaggedErrorClass<NmdObjectStoreError>()(
  'NmdObjectStoreError',
  {
    path: Schema.String,
...
export class NmdConflictError extends Schema.TaggedErrorClass<NmdConflictError>()(
  'NmdConflictError',
  {
    path: Schema.String,
...
export class NmdFileSystemError extends Schema.TaggedErrorClass<NmdFileSystemError>()(
  'NmdFileSystemError',
  {
...
export class NmdGatewayError extends Schema.TaggedErrorClass<NmdGatewayError>()('NmdGatewayError', {
  operation: Schema.String,
...
export class NmdRemoteBodyLossyError extends Schema.TaggedErrorClass<NmdRemoteBodyLossyError>()(
 ...
 */
export class NmdSchemaDriftError extends Schema.TaggedErrorClass<NmdSchemaDriftError>()(
  'NmdSchemaDriftError',
  {
    page_id: Schema.String,
 ...
 */
export class NmdPropertyWriteBlockedError extends Schema.TaggedErrorClass<NmdPropertyWriteBlockedError>()(
 ...
 */
export class NmdNonBodyWriteBlockedError extends Schema.TaggedErrorClass<NmdNonBodyWriteBlockedError>()(
 ...
 */
export class NmdDestructiveBodyBlockedError extends Schema.TaggedErrorClass<NmdDestructiveBodyBlockedError>()(
...
export class NmdTokenMissingError extends Schema.TaggedErrorClass<NmdTokenMissingError>()(
 ...
 */
export class NmdUnresolvablePageError extends Schema.TaggedErrorClass<NmdUnresolvablePageError>()(
 ...
 */
export class NmdInvalidDocumentError extends Schema.TaggedErrorClass<NmdInvalidDocumentError>()(
...
export class NmdEditorAbortedError extends Schema.TaggedErrorClass<NmdEditorAbortedError>()(
 ...
 */
export class NmdPostPushGateError extends Schema.TaggedErrorClass<NmdPostPushGateError>()(
 ...
 */
export class NmdPartialWriteError extends Schema.TaggedErrorClass<NmdPartialWriteError>()(
...
export class NmdCliError extends Schema.TaggedErrorClass<NmdCliError>()('NmdCliError', {
  message: Schema.String,
}) {}
