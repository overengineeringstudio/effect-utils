...
export const NonBodyGuardName = Schema.Literal(...nonBodyGuardNames).annotate({
...
export const DestructiveBodyGuardName = Schema.Literal(...destructiveBodyGuardNames).annotate({
