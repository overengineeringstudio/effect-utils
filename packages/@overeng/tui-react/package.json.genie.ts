...
const effectAtomDeps = ['@effect/atom-react'] as const
    ...
    publishConfig: {
      ...
      exports: {
        ...
        './storybook': {
          ...
          default: './dist/src/storybook/mod.js',
        },
        './opentui': {
          types: './dist/src/effect/opentui/mod.d.ts',
          default: './dist/src/effect/opentui/mod.js',
        },
      },
    },
