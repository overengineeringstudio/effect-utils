...
the package `tsconfig` and `devenv tasks run buck2:quick`).
...
the same for the self-reschedule example. So `devenv tasks run check:all` both type-checks every
...
| Endpoint (`layer` / `serve`)     | [`04-endpoint.ts`](../../examples/04-endpoint.ts)                                             | `buck2:quick`                                   |
| Determinism + descriptors        | [`05-determinism.ts`](../../examples/05-determinism.ts)                                       | `buck2:quick`                                   |
...
| Annotations + redaction          | [`08-annotations.ts`](../../examples/08-annotations.ts)                                       | `buck2:quick`                                   |
| OTel bridge                      | [`09-otel.ts`](../../examples/09-otel.ts)                                                     | `buck2:quick`                                   |
...
| Admin operations runbook         | [`13-admin-operations.ts`](../../examples/13-admin-operations.ts)                             | `admin.integration.test.ts`                     |
| HTTP error classification        | [`14-http-error-classification.ts`](../../examples/14-http-error-classification.ts)           | `http-error-classification.integration.test.ts` |
