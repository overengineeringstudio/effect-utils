...
describe('CLI JSON output contracts', () => {
  it('preserves representative status JSON', () => {
    ...
    expect(encodeJson(CiStateSchema, state)).toMatchInlineSnapshot(
      `"{"_tag":"Loaded","run":{"id":23601797547,"name":"CI","runNumber":1940,"headBranch":"example/feature","status":"completed","conclusion":"success","event":"push","workflowPath":".github/workflows/ci.yml","htmlUrl":"https://github.com/example-org/example-repo/actions/runs/23601797547","elapsedSeconds":42},"jobs":[{"id":69067527707,"name":"lint","status":"completed","conclusion":"success","durationSeconds":37,"runner":"runner-host-a","runnerName":"runner-host-a","runnerKind":"other","runnerInstance":"runner-host-a","jobUrl":"https://github.com/example-org/example-repo/actions/runs/0/job/69067527707","failedStepName":null}],"errors":[],"annotations":[],"runnerHostMap":[["runner-a","runner-host-a"]],"prHealth":null,"summary":{"overallStatus":"passing","critical":[],"warnings":[]},"_meta":{"apiRequests":7,"apiRequestsCached":2,"rateLimitRemaining":4993,"rateLimitLimit":5000}}"`,
    )
  })
