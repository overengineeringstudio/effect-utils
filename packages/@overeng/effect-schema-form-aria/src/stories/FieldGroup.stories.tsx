...
import type { FieldGroupProps } from '../components/FieldGroup.tsx'
...
const DefaultRender = (args: FieldGroupProps) => {
...
const SubtleRender = (args: FieldGroupProps) => {
...
const MixedFieldsRender = (args: FieldGroupProps) => {
...
const NestedRender = (args: FieldGroupProps) => {
  const [email, setEmail] = useState('')
  const [marketing, setMarketing] = useState(false)
  const [security, setSecurity] = useState(true)
  return (
    <FieldGroup {...args}>
      <TextField id="account-email" label="Email" value={email} onChange={setEmail} type="email" />
