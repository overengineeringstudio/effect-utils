...
fn main() -> ExitCode {
    ...
    match args.get(1).map(String::as_str) {
        ...
        Some("--print-schema") => {
            ...
            println!(
                r#"{{"schemas":["otelite.endpoints/v1","otelite.summary/v1","otelite.span/v1","otelite.trace-summary/v1","otelite.metric/v1","otelite.metric-summary/v1","otelite.log/v1","otelite.log-summary/v1"]}}"#
            );
            ExitCode::SUCCESS
        }
        Some(other) => {
