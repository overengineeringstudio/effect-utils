...
describe('task factory', () => {
  describe('command tasks', () => {
    it('creates command task with correct structure', () => {
      const t = task({
        id: 'test-cmd',
        name: 'Test Command',
        command: {
    ...
    it('creates command task with dependencies', () => {
      const t = task({
        id: 'dependent',
        name: 'Dependent Task',
        command: {
    ...
    it('creates command task with cwd and env', () => {
      const t = commandTask({
        id: 'custom-cmd',
        name: 'Custom Command',
        cmd: 'npm',
  ...
  describe('effect tasks', () => {
    it('creates effect task with correct structure', () => {
    ...
    it('creates effect task with dependencies', () => {
      const testEffect = Effect.succeed('result')
      const t = task({
        id: 'dependent-effect',
  ...
  describe('helper functions', () => {
    it('commandTask creates valid task', () => {
      const t = commandTask({
        id: 'cmd-helper',
        name: 'Command Helper',
        cmd: 'ls',
    ...
    it('effectTask creates valid task', () => {
  ...
  describe('type discrimination', () => {
    it('correctly identifies command spec vs effect', () => {
