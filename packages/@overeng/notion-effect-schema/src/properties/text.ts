...
export const TitleWriteFromString = Schema.String.pipe(
  Schema.decodeTo(
    TitleWrite,
    SchemaTransformation.transform<Schema.Codec.Encoded<typeof TitleWrite>, string>({
      decode: (str) => ({
...
export const Title = {
  ...
  raw: TitleProperty.pipe(
    Schema.decodeTo(Schema.toType(RichTextArray), {
      decode: SchemaGetter.transform((prop) => prop.title),
  ...
  asString: TitleProperty.pipe(
    Schema.decodeTo(Schema.String, {
      decode: SchemaGetter.transform((prop) => prop.title.map((rt) => rt.plain_text).join('')),
      encode: SchemaGetter.forbidden(
...
export const RichTextWriteFromString = Schema.String.pipe(
  Schema.decodeTo(
    RichTextWrite,
    SchemaTransformation.transform<Schema.Codec.Encoded<typeof RichTextWrite>, string>({
      decode: (str) => ({
...
export const RichTextProp = {
  ...
  raw: RichTextProperty.pipe(
    Schema.decodeTo(Schema.toType(RichTextArray), {
      decode: SchemaGetter.transform((prop) => prop.rich_text),
      encode: SchemaGetter.forbidden(
        () =>
  ...
  asString: RichTextProperty.pipe(
    Schema.decodeTo(Schema.String, {
      decode: SchemaGetter.transform((prop) => prop.rich_text.map((rt) => rt.plain_text).join('')),
      encode: SchemaGetter.forbidden(
        () =>
