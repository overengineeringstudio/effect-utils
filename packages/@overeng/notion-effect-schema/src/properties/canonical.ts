...
const NonEmptyTrimmedString = Schema.NonEmptyString.pipe(Schema.check(Schema.isTrimmed()))

/** Branded Notion property ID (stable identifier within a database schema). */
export const PropertyId = NonEmptyTrimmedString.pipe(
...
export const PropertyName = NonEmptyTrimmedString.pipe(
...
export const PageId = NonEmptyTrimmedString.pipe(
 ...
 */
export const DataSourceId = NonEmptyTrimmedString.pipe(
...
export const CanonicalFileValue = Schema.TaggedStruct('CanonicalFileValue', {
  ...
  externalUrl: Schema.optional(NonEmptyTrimmedString),
...
export const CanonicalPropertyValue = Schema.Union([
  ...
  Schema.TaggedStruct('people', {
    userIds: Schema.Array(NonEmptyTrimmedString),
  }),
