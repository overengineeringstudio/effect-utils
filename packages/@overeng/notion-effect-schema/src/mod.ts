...
export {
  ...
  NotionBlockCreate as NotionBlockCreateSchema,
  type BlockParent,
  ...
  type CommentParent,
  CommentParent as CommentParentSchema,
  ...
  DatabaseSchema,
  type DataSourceRef,
  DataSourceRef as DataSourceRefSchema,
  DataSourceSchema,
  type EmojiIcon,
  ...
  type RichTextCreateArray,
  RichTextCreateArray as RichTextCreateArraySchema,
  type TableRowBlockCreate,
  TableRowBlockCreate as TableRowBlockCreateSchema,
  type View,
  View as ViewSchema,
  type ViewType,
  ViewType as ViewTypeSchema,
} from './objects.ts'
...
export {
  ...
  TextAnnotationsCreate as TextAnnotationsCreateSchema,
  type TextLink,
  TextLink as TextLinkSchema,
  type TextRichText,
  TextRichText as TextRichTextSchema,
  type TextRichTextCreate,
  TextRichTextCreate as TextRichTextCreateSchema,
  type UserMention,
