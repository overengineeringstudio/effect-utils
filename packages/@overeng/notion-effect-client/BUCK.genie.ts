...
npm_package_product(
    name = "dist-package",
    archive_name = "overeng-notion-effect-client.tgz",
    dist = ":dist",
    package_json = "package.json",
    product_name = "@overeng/notion-effect-client",
    transport_slug = "overeng-notion-effect-client",
    package_dependencies = [
        "//packages/@overeng/content-address:dist-package",
        "//packages/@overeng/notion-core:dist-package",
        "//packages/@overeng/notion-effect-schema:dist-package",
