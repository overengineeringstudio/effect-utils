...
Styled React Aria implementation for `@schickling/effect-schema-form`. Provides accessible, styled form components using React Aria Components and Tailwind CSS.

## Installation

```bash
pnpm add @schickling/effect-schema-form-aria @schickling/effect-schema-form react-aria-components
```
...
```tsx
import { AriaSchemaForm } from '@schickling/effect-schema-form-aria'
...
```tsx
import { SchemaFormProvider, SchemaForm } from '@schickling/effect-schema-form'
import { ariaRenderers } from '@schickling/effect-schema-form-aria'
...
import {
  ...
  FieldWrapper,
  FieldGroup,
} from '@schickling/effect-schema-form-aria'
```
