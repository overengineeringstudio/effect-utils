...
- **Buck2 evidence safety**: accept generated v2 closure projections, redact
  ...
  local, redact authorization schemes with their CLI credentials, reject invalid
  materialization counters, and reject unknown descriptor fields, duplicate or
  non-canonical entrypoints, reserved importer metadata, oversized or sparse
