...
- **otel-scrape**: `deadnix` adapter (`src/adapters/deadnix.rs`) — a diagnostics
  ...
  framework.
- **otel-scrape**: adapter fleet VRS under `context/otel-utils/otel-scrape/adapters/` — the
