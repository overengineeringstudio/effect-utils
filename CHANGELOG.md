...
- **@overeng/notion-datasource-sync**: Promote guarded public SQLite relation removals from fully paginated relation bases, preserving all remaining related pages through replacement-shaped Notion writes with fake and disposable live E2E coverage while keeping relation additions and people writes fail-closed.
