...
- **CI / Nix packages**: Refresh the stale `genie`, `megarepo`, and `tui-stories` pnpm fixed-output hashes after the schema-first OTEL contract change updated the workspace dependency closure.
