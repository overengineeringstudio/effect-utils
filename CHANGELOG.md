...
- **@overeng/oxc-config**: add `overeng/no-stdout-workflow-command` (enabled as `error` in the base
  config), flagging GitHub workflow commands passed to `console.log`/`console.info` or
