...
- **@overeng/notion-md**: Preserve authored directory-tree child indexes when parent bodies contain block-level `<page>` anchors, while failing closed on missing, duplicate, or dangling child anchors.
