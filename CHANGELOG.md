...
- **@overeng/notion-cli docs**: Add package-level VRS requirements, spec, glossary, and a decision record for the umbrella CLI surface and Node-backed `notion db` runtime boundary.
