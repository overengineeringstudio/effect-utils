...
- **genie**: Separate SDK types from CLI/TUI types so `@overeng/genie/sdk` no longer transitively
  pulls in `@overeng/tui-react` — consumers no longer need `jsx` in their tsconfig.
