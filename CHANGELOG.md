...
- **@overeng/notion-cli**: Replace shell-based `notion md` / `notion sqlite` dispatch with in-process Effect command dispatch to `@overeng/notion-md` and `@overeng/notion-datasource-sync` handlers.
