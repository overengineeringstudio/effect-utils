...
- **nix/workspace-tools**: Cap pnpm child/network concurrency inside fixed-output pnpm deps builds so Darwin CI does not get `Killed: 9` while materializing whole-workspace install roots.
