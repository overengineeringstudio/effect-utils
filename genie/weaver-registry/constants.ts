...
export const GenieFileMode = 'genie.file.mode' as const
export const GenieFileSource_path = 'genie.file.source_path' as const
export const GenieFileTarget_path = 'genie.file.target_path' as const
export const GenieOxfmtHas_config = 'genie.oxfmt.has_config' as const
export const GeniePath = 'genie.path' as const
...
export const Notion_mdMedia_boundaryOperation = 'notion_md.media_boundary.operation' as const
export const Notion_mdMedia_boundaryVerdict = 'notion_md.media_boundary.verdict' as const
export const Notion_mdObject_gcDry_run = 'notion_md.object_gc.dry_run' as const
export const Notion_mdObject_gcReachable_count = 'notion_md.object_gc.reachable_count' as const
export const Notion_mdObject_gcRemoved_count = 'notion_md.object_gc.removed_count' as const
export const Notion_mdObjectHash_prefix = 'notion_md.object.hash_prefix' as const
export const Notion_mdObjectRole = 'notion_md.object.role' as const
export const Notion_mdPage_id = 'notion_md.page_id' as const
export const Notion_mdPage_metadataCover = 'notion_md.page_metadata.cover' as const
export const Notion_mdPage_metadataIcon = 'notion_md.page_metadata.icon' as const
export const Notion_mdPage_metadataIn_trash = 'notion_md.page_metadata.in_trash' as const
export const Notion_mdPage_metadataIs_locked = 'notion_md.page_metadata.is_locked' as const
export const Notion_mdPage_metadataTitle = 'notion_md.page_metadata.title' as const
...
export const Notion_mdPushPushed = 'notion_md.push.pushed' as const
export const Notion_mdPutBody_written = 'notion_md.put.body_written' as const
export const Notion_mdPutForce = 'notion_md.put.force' as const
...
export const Notion_mdWatchReason = 'notion_md.watch.reason' as const
