 ...
 * CI must use `apply --all` so stacked branch locks remain exact and
 * reproducible. Resolves the CLI inline with `nix run` to avoid
 * `nix profile install` conflicts on self-hosted runners.
 */
