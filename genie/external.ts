...
export const catalog = defineCatalog({
   ...
   * `babel-loader` is resolved from the consuming app. The fixture's Next
   * and PostCSS versions stay local to @overeng/utils so consumers can
   * select their own versions.
   */
